...
<title>NCWIT-NJ</title>
 ...
 <ul>
                    <div class="container">
                      <div align="left">
                        <div class="col-1">
                        <a href = "https://www.aspirations.org/aspirations-community/new-jersey"><img src="NCWIT_AiCProgram_Logo_FullColor.png" class="img-responsive" alt="NCWIT logo" 
             width="150"/></a>
                      </div>
                      </div>
                    </div>
                   <div class="container">
                      <div class="example">
                        <div class = "nav" class= "button">
                          <li>
                          <a style="text-decoration:none"href="RisingStarCertificateTemplate.php" class="current">Rising Star</a>
                        </li>
                      </div>
                    </div>
                     <div class="container">
...
if($_GET['keywords'] == '*'){
	$query = "SELECT * FROM `rising star certificate templat`";
} else if ($_GET['keywords']== '') {
	echo "<font color = 'white'>You have not entered any characters, please enter matching characters!";

} else {
	$query = "SELECT * FROM `rising star certificate templat` where A  = '".$_GET['keywords']."'";
}
...
echo "<table class = 'center'>
		<tr>
			...
			<th> <font size='+1'>Affiliate Name: New Jersey Affiliate</font></th>
          <th>High School</th>
      ...
      echo"<td><b>".$row['B']."</b></td>";
		...
		echo "</TABLE>\n";	
 		...
 		echo "<br>there are no transactions in customer <b>" . $row['A'] ."</b>  with such keywords as: <b>" . $_GET['keywords'] . "</b>";
